...
const DUMMY_USER = {
  ...
  name: "Test User",
  picture:
    "https://ui-avatars.com/api/?name=Test+User&background=f43f5e&color=fff",
...
function LandingPageContent({ onLoginSuccess }: LandingPageProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen bg-gradient-to-br from-rose-50 via-white to-amber-50 relative overflow-hidden"
    >
      ...
      <div className="relative z-10">
        ...
        <section className="container mx-auto px-4 py-16 md:py-24">
          <div className="max-w-5xl mx-auto text-center">
            ...
            >
              Moments uses advanced AI facial recognition to help guests at
              weddings, parties, and events instantly find all photos featuring
              them. No more scrolling through thousands of pictures.
            </motion.p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Moments is an AI-powered photo discovery platform designed for
                events. Event photographers can upload all their photos, and
                guests simply take a selfie to instantly find every photo they
                appear in. No manual tagging, no endless scrolling - just magic.
              </p>
            </motion.div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <motion.div
                ...
                whileHover={{
                  y: -5,
                  boxShadow: "0 25px 50px rgba(251, 113, 133, 0.2)",
                }}
              >
              ...
              <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
                ...
                >
                  ...
                  <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
                    Moments is proudly open source. We believe in transparency
                    and community collaboration. Check out our code, contribute,
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Start using Moments today and give your event guests an
                unforgettable experience. No credit card required for the free
                plan.
              </p>
              <motion.button
                onClick={handleSignIn}
                ...
                whileHover={{
                  scale: 1.05,
                  boxShadow: "0 25px 50px rgba(251, 113, 133, 0.3)",
                }}
                whileTap={{ scale: 0.97 }}
              >
